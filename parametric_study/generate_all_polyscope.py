...
output_base = "/Users/yeonsu/GitHub/rod-dynamics-3d/renderings/polyscope"
...
for N in N_values:
    ...
    print(f"Polyscope rendering N={N} ...")
    subprocess.run(cmd, capture_output=True)
    
    if os.path.exists(screenshot_path):
        print(f"  Saved to {screenshot_path}")
    else:
        print(f"  Failed Polyscope N={N}")

print("All Polyscope renderings complete.")
