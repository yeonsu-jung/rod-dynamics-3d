#!/bin/bash
# iter_analyze_stable_core_vs_n.sh
# 
# Iterates over relax3rd_N*_sweep folders and submits stable core analysis jobs.
...
for dir in "$RUNS_BASE"/relax3rd_*_sweep; do
    if [ -d "$dir" ]; then
        ...
        echo "---------------------------------------------------"
        echo "Submitting stable core analysis for: $(basename "$dir")"
        echo "N=$N"
...
echo "Done submitting stable core analysis jobs."
