...
SCENE = os.path.join(ROOT, "assets", "scenes", "spinning_two_rods_soft.json")
PROFILE = os.path.join(ROOT, "spinning_two_rods_profile.csv")
...
def main():
    ...
    plt.title("Two spinning rods soft-contact KE vs time")
    plt.legend()
    plt.tight_layout()
    out_png = os.path.join(ROOT, "spinning_two_rods_ke.png")
